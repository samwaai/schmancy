...
window.getChildAtIndex = getChildAtIndex;
window.getChildLength = getChildLength;
window.forEachChildren = forEachChildren;
window.testObject = testObject;
window.anOtherTestObject = anOtherTestObject;
