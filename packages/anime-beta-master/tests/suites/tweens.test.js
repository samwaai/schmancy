...
suite('Tweens', () => {
  ...
  // test('Path tween', () => {
  //   const animation = animate(   targets: '#path', {
  //     translateX: '100%',
  //   });

  //   expect(getChildAtIndex(animation, 0).isPath).to.equal(true);
  // });
  ...
  test('Correct tweens override and from value definition', () => {
    ...
    const animA = /** @type {AnimationObject} */(tl._head._next._next._next._next._next._next);
    const animB = /** @type {AnimationObject} */(animA._next._next._next._next);
