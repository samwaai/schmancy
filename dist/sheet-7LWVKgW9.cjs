require(`./chunk-BCfY8kxB.cjs`);const e=require(`./decorate-F9CuyeHg.cjs`),t=require(`./litElement.mixin-Bx9Avv0M.cjs`);require(`./mixins.cjs`);const n=require(`./area-CBjmKtN-.cjs`),r=require(`./animation-Bcwh107v.cjs`),i=require(`./sheet.service-P2CkJW86.cjs`);let a=require(`rxjs`),o=require(`lit/decorators.js`),s=require(`lit`);var c,l,u=class extends t.t(s.css`
	:host {
		position: fixed;
		inset: 0;
