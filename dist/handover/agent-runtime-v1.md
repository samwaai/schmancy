...
```
https://esm.sh/@mhmo91/schmancy/agent@0.9.16
https://esm.sh/@mhmo91/schmancy/agent/manifest@0.9.16
```
...
<!doctype html>
<script type="module">
  import { $dialog, theme } from 'https://esm.sh/@mhmo91/schmancy/agent@0.9.16';
</script>
