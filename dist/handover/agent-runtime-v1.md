...
```
https://esm.sh/@mhmo91/schmancy/agent@0.9.17
https://esm.sh/@mhmo91/schmancy/agent/manifest@0.9.17
```
...
<!doctype html>
<script type="module">
  import { $dialog, theme } from 'https://esm.sh/@mhmo91/schmancy/agent@0.9.17';
</script>
