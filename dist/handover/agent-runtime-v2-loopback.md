...
| 9 | `0.9.22` templating for handover docs | same branch as #2 | None user-facing. Future handover docs will have live esm.sh URLs instead of `<PENDING>` placeholders. |
...
```
https://esm.sh/@mhmo91/schmancy/agent@0.9.22
https://esm.sh/@mhmo91/schmancy/agent/manifest@0.9.22
```

`0.9.22` is substituted at publish time — see [`agent-runtime-followups.md`](./agent-runtime-followups.md) #9. Until the PRs land, continue pinning `@0.9.14` (the last published version at time of writing).
...
<!doctype html>
<script type="module">
  import 'https://esm.sh/@mhmo91/schmancy/agent@0.9.22';
</script>
