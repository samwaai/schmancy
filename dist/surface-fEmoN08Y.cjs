require(`./chunk-CncqDLb2.cjs`);const e=require(`./tailwind.mixin-BHX99hgX.cjs`),t=require(`./provide-B7b5TOCD.cjs`),n=require(`./decorate-F9CuyeHg.cjs`),r=require(`./surface.mixin-DxOi-xo0.cjs`);let i=require(`lit/decorators.js`),a=require(`lit`);var o=e.o(`surface`),s=class extends r.t(e.t(a.css`
		:host {
			display: block;
