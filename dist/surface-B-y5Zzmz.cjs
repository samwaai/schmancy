require(`./chunk-BCfY8kxB.cjs`);const e=require(`./tailwind.mixin-ZzkXQTFA.cjs`),t=require(`./provide-BbFbvIEk.cjs`),n=require(`./decorate-F9CuyeHg.cjs`),r=require(`./surface.mixin-CSKqQH-0.cjs`);let i=require(`lit/decorators.js`),a=require(`lit`);var o=e.o(`surface`),s=class extends r.t(e.t(a.css`
		:host {
			display: block;
