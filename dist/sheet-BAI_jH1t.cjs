require(`./chunk-CncqDLb2.cjs`);const e=require(`./decorate-F9CuyeHg.cjs`),t=require(`./litElement.mixin-qh5-IIUq.cjs`);require(`./mixins.cjs`);const n=require(`./area-D7l9KR2N.cjs`),r=require(`./animation-CQRdLgzX.cjs`),i=require(`./sheet.service-RcDBwHmv.cjs`);let a=require(`rxjs`),o=require(`lit/decorators.js`),s=require(`lit`);var c,l,u=class extends t.t(s.css`
	:host {
		position: fixed;
		inset: 0;
