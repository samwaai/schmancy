var e = class {
	constructor(e) {
		this._map = /* @__PURE__ */ new Map(), this._roundAverageSize = !1, this.totalSize = 0, !0 === e?.roundAverageSize && (this._roundAverageSize = !0);
	}
	set(e, t) {
...
var n = class {
	...
	set direction(e) {
		(e = e === "horizontal" ? e : "vertical") !== this._direction && (this._direction = e, this._sizeDim = e === "horizontal" ? "width" : "height", this._secondarySizeDim = e === "horizontal" ? "height" : "width", this._positionDim = e === "horizontal" ? "left" : "top", this._secondaryPositionDim = e === "horizontal" ? "top" : "left", this._triggerReflow());
	}
	get viewportSize() {
...
var s = class {
	...
	_getItems() {
		let e = this._newPhysicalItems, t, n;
		if (this._stable = !0, this.pin !== null) {
			let { index: e } = this.pin;
			this._anchorIdx = e, this._anchorPos = this._getPosition(e);
		}
		if (t = this._scrollPosition - this._overhang, n = this._scrollPosition + this._viewDim1 + this._overhang, n < 0 || t > this._scrollSize) return void this._clearItems();
		...
		for (this._anchorPos + r + a < t && (o = t - (this._anchorPos + r + a)), this._anchorPos - i > n && (o = n - (this._anchorPos - i)), o && (this._scrollPosition -= o, t -= o, n -= o, this._scrollError += o), e.set(this._anchorIdx, {
			...
			if (e.set(this._first, {
				pos: r,
				size: t
			}), this._physicalMin -= n, !1 === this._stable && !1 === this._estimate) break;
		}
