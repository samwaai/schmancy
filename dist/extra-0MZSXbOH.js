...
`) {
	...
	constructor() {
		super(), this.chip = "", this.required = !1, this.label = "Country", this.hint = "Please select a country", this.placeholder = "Select a country", this.name = "";
		try {
	...
	checkValidity() {
		return !this.required || this.value && this.value !== "" ? (this.internals?.setValidity({}), !0) : (this.internals?.setValidity({ valueMissing: !0 }, "Please select a country"), !1);
	}
	reportValidity() {
		let e = this.checkValidity();
		return !e && this.autocomplete && this.autocomplete.reportValidity(), e;
	}
	updated(e) {
		e.has("value") && this.internals?.setFormValue(this.value || "");
	}
	handleChange(e) {
		this.value = e.detail.value, this.dispatchEvent(new Event("change", { bubbles: !0 })), this.checkValidity();
	}
	render() {
		return s`
			...
			>
				${c(l ?? [], (e) => e.code, (e) => s` <schmancy-option value=${e.code ?? ""}> ${e.name} </schmancy-option> `)}
			</schmancy-autocomplete>
		`;
	}
};
e([r({
	...
	reflect: !0,
	attribute: "value"
})], u.prototype, "value", void 0), e([a()], u.prototype, "chip", void 0), e([r({
	type: Boolean,
	reflect: !0
})], u.prototype, "required", void 0), e([r({ type: String })], u.prototype, "label", void 0), e([r({ type: String })], u.prototype, "hint", void 0), e([r({ type: String })], u.prototype, "placeholder", void 0), e([r({ type: String })], u.prototype, "name", void 0), e([i("schmancy-autocomplete")], u.prototype, "autocomplete", void 0), u = e([n("schmancy-select-countries")], u);
var d = [
	{
...
`) {
	...
	constructor() {
		super(), this.chip = "", this.required = !1, this.label = "Timezone", this.hint = "Please select a timezone", this.placeholder = "Select a timezone", this.name = "";
		try {
			this.internals = this.attachInternals();
		} catch {}
	}
	...
	checkValidity() {
		return !this.required || this.value && this.value !== "" ? (this.internals?.setValidity({}), !0) : (this.internals?.setValidity({ valueMissing: !0 }, "Please select a timezone"), !1);
	}
	reportValidity() {
		let e = this.checkValidity();
		return !e && this.autocomplete && this.autocomplete.reportValidity(), e;
	...
	render() {
		return s`
			<schmancy-autocomplete
				...
				@change=${this.handleChange}
			>
				${c(d ?? [], (e) => e.tzCode, (e) => s` <schmancy-option value=${e.tzCode ?? ""}> ${e.name} </schmancy-option> `)}
			</schmancy-autocomplete>
		`;
	}
};
e([r({
	...
	reflect: !0,
	attribute: "value"
})], f.prototype, "value", void 0), e([a()], f.prototype, "chip", void 0), e([r({
	type: Boolean,
	reflect: !0
})], f.prototype, "required", void 0), e([r({ type: String })], f.prototype, "label", void 0), e([r({ type: String })], f.prototype, "hint", void 0), e([r({ type: String })], f.prototype, "placeholder", void 0), e([r({ type: String })], f.prototype, "name", void 0), e([i("schmancy-autocomplete")], f.prototype, "autocomplete", void 0), f = e([n("schmancy-select-timezones")], f);
