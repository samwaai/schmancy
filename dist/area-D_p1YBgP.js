...
function L(e) {
	let t = function() {
		return t._promise ? t._promise : t._module ? Promise.resolve(t._module) : (t._promise = e().then((e) => (t._module = e, e)).catch((e) => {
			throw t._promise = void 0, e;
		}), t._promise);
	};
	return t.preload = async function() {
		try {
			await t();
		} catch {}
	}, t;
...
function K(e, t) {
	...
	if (typeof e.component == "string" && typeof t.component == "string") {
		if (z(e.component) !== z(t.component)) return !1;
	} else if (typeof e.component == "function" && typeof t.component == "function") {
		if (!R(e.component, t.component)) return !1;
...
function J(e) {
	let t = B(e.component) || "unknown", n = Y(JSON.stringify(e.state || {})), r = Y(JSON.stringify(e.params || {}));
	return `${e.area}:${t}:${n}:${r}`;
}
function Y(e) {
	let t = 0;
...
function X(e, t = [
	...
	for (let r in e) if (e.hasOwnProperty(r) && !t.includes(r)) {
		let i = e[r];
		H(i) ? n[r] = X(i, t) : Array.isArray(i) ? n[r] = i.map((e) => H(e) ? X(e, t) : e) : n[r] = i;
	}
	return n;
}
function Z(e) {
...
export { j as C, k as S, F as _, J as a, M as b, V as c, B as d, H as f, I as g, L as h, K as i, W as l, X as m, q as n, U as o, z as p, R as r, G as s, Q as t, Z as u, P as v, D as w, O as x, N as y };
