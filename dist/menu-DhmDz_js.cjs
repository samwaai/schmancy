require(`./chunk-BCfY8kxB.cjs`);const e=require(`./decorate-F9CuyeHg.cjs`),t=require(`./litElement.mixin-Bx9Avv0M.cjs`);require(`./mixins.cjs`);const n=require(`./dialog-service-DXLGSshF.cjs`);let r=require(`lit/decorators.js`),i=require(`lit`);var a=class extends t.t(i.css`
	:host {
		display: block;
	}
