 ...
 */
export type Anchor = MouseEvent | TouchEvent | HTMLElement | DOMRect | VirtualAnchor | {
    x: number;
    y: number;
};
/**
 ...
 */
export type CloseReason = 'structured' | 'native-submit' | 'escape' | 'backdrop' | 'swipe' | 'popstate' | 'light-dismiss' | 'programmatic' | 'abort';
/**
 ...
 */
export type ShowFn = <T = void>(content: Content, options?: ShowOptions) => Observable<T | undefined>;
