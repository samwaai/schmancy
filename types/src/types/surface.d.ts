...
export type TSurfaceColorNew = 'solid' | 'subtle' | 'glass' | 'luminous' | 'transparent' | 'outlined' | 'primary' | 'secondary' | 'tertiary' | 'error' | 'success' | 'warning' | 'info';
/**
 ...
 */
export type TSurfaceColorLegacy = 'surface' | 'surfaceDim' | 'surfaceBright' | 'containerLowest' | 'containerLow' | 'container' | 'containerHigh' | 'containerHighest' | 'glassOforim';
