...
export class DemoFormsAutocomplete extends $LitElement() {
  ...
  private cities = [
    ...
    'Kansas City', 'Mesa', 'Atlanta', 'Long Beach', 'Colorado Springs',
  ...
  render() {
    return html`
      <schmancy-surface class="p-8">
            ...
            <schmancy-code-preview language="html">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="col-span-full">
                  ${this.selectedLanguages.length > 0 ? html`
                    <schmancy-surface type="surfaceDim" class="rounded-lg p-4">
                      <schmancy-typography type="body" token="sm" class="mb-2">
                        Selected Languages:
                      </schmancy-typography>
                      <div class="flex flex-wrap gap-2">
                        ${this.selectedLanguages.map(lang => html`
                          <schmancy-chip type="assist">${lang}</schmancy-chip>
                        `)}
                      </div>
                    </schmancy-surface>
                  ` : ''}
        ...
        <div class="mb-12">
          <schmancy-typography type="title" token="lg" class="mb-6 block">Dynamic Data with Repeat Directive</schmancy-typography>
            ...
            <schmancy-code-preview language="html">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  ${this.selectedTerminals.length > 0 ? html`
                    <div class="mt-2">
                    ...
                    ${repeat(
                      ...
                      product => html`
                        ...
                        >
                          <div class="flex justify-between items-center w-full">
                            <div>
                              <div class="font-medium ${!product.inStock ? 'opacity-50' : ''}">
                                ${product.name}
                              </div>
                            ...
                            ${product.inStock ? html`
                              <schmancy-chip type="assist" size="sm" class="text-green-600">In Stock</schmancy-chip>
                            ` : html`
                              <schmancy-chip type="assist" size="sm" class="text-red-600">Out of Stock</schmancy-chip>
                            `}
                          </div>
                        </schmancy-option>
                      `
          ...
          <schmancy-surface type="surfaceDim" class="rounded-lg p-6">
            ...
            <pre class="bg-surface-container p-4 rounded overflow-x-auto"><code class="text-sm">import { repeat } from 'lit/directives/repeat.js';
...
&lt;schmancy-autocomplete
  ...
  @change=\${(e) => this.selectedValues = e.detail.values}
&gt;
  \${repeat(
...
&lt;/schmancy-autocomplete&gt;</code></pre>
          </schmancy-surface>
        </div>
        ...
        <div class="mb-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <schmancy-surface type="surfaceDim" class="rounded-lg p-6">
              ...
              <schmancy-typography type="body" token="sm" class="text-surface-onVariant">
                Intelligent similarity scoring algorithm finds best matches even with typos.
                Searches both labels and values, with configurable threshold.
              </schmancy-typography>
            </schmancy-surface>
            ...
            <schmancy-surface type="surfaceDim" class="rounded-lg p-6">
              ...
              <schmancy-typography type="body" token="sm" class="text-surface-onVariant">
                Full keyboard support: Arrow keys to navigate, Enter to select,
                Escape to close, Tab to move to next field.
              </schmancy-typography>
            </schmancy-surface>
            ...
            <schmancy-surface type="surfaceDim" class="rounded-lg p-6">
              ...
              <schmancy-typography type="body" token="sm" class="text-surface-onVariant">
                In single-select mode, automatically selects the best matching option
                when the input loses focus, speeding up data entry.
              </schmancy-typography>
            </schmancy-surface>
            ...
            <schmancy-surface type="surfaceDim" class="rounded-lg p-6">
              ...
              <schmancy-typography type="body" token="sm" class="text-surface-onVariant">
                Full ARIA support with proper roles, screen reader announcements,
                and focus management for an inclusive experience.
              </schmancy-typography>
            </schmancy-surface>
          </div>
        </div>
        ...
        <!-- Performance Tips -->
        <div class="mb-12">
          <schmancy-typography type="title" token="lg" class="mb-4 block">Performance Tips with Dynamic Data</schmancy-typography>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <schmancy-surface type="surfaceDim" class="rounded-lg p-6">
              ...
              <schmancy-typography type="body" token="sm" class="text-surface-onVariant">
                When rendering lists from dynamic data (API responses, state arrays), use the repeat directive
                with a stable key function. This ensures efficient DOM updates when items are added, removed, or reordered.
              </schmancy-typography>
            </schmancy-surface>
            ...
            <schmancy-surface type="surfaceDim" class="rounded-lg p-6">
              ...
              <schmancy-typography type="body" token="sm" class="text-surface-onVariant">
                Always use unique, stable IDs as keys (e.g., database IDs, UUIDs). Avoid using array indices
                as keys when the list can be reordered or filtered, as this causes unnecessary re-renders.
              </schmancy-typography>
            </schmancy-surface>
            ...
            <schmancy-surface type="surfaceDim" class="rounded-lg p-6">
              ...
              <schmancy-typography type="body" token="sm" class="text-surface-onVariant">
                When dealing with large datasets, filter your data array before passing it to repeat.
                This reduces the number of DOM nodes created and improves search performance.
              </schmancy-typography>
            </schmancy-surface>
            ...
            <schmancy-surface type="surfaceDim" class="rounded-lg p-6">
              ...
              <schmancy-typography type="body" token="sm" class="text-surface-onVariant">
                For complex option templates with multiple elements, consider memoizing the template
                function or pre-computing display values to avoid recalculation on every render.
              </schmancy-typography>
            </schmancy-surface>
          </div>
        </div>
