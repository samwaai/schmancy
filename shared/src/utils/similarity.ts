 ...
 * @param removeAccents Whether to remove accents/diacritics (default: true)
 * @returns The normalized string
 *
 * @example
 * normalizeString("  Hello   World  ") // "hello world"
 * normalizeString("CAFÉ") // "cafe"
 * normalizeString("CAFÉ", false) // "café"
 */
export function normalizeString(str: string, removeAccents: boolean = true): string {
